...
<body>
  ...
  <section class="find_section">
    <div class="container">
      <form action="login_submited.php" method="post">
        <h3 style="text-align: center; margin-top: 10%">Login</h3>
        <div class="sale_section layout_padding-bottom">
            <div class="container-fluid">
                <div class="heading_container"><br>
                <?php if (!empty($signupMessage)) {
                    if (($signupMessage === "Login failed. Invalid username.") or ($signupMessage === "Login failed. Invalid password.")) {?>
                    <i style="color: red"><?php echo $signupMessage; ?></i>
                <?php } else {?>
                    <i style="color: green"><?php echo $signupMessage; ?></i>
                <?php }
                }?>
                    <div class="col-md-5">
                        <br><input type="text" class="form-control" placeholder="Username " name="username">
                    </div>
                    <div class="col-md-5">
